  ...
  return (
    <div style={estilos.contenedorPrincipal}>
      ...
      <aside style={estilos.barraLateral}>
        ...
        {/* Tu nombre agregado limpiamente como texto estático abajo */}
...
const estilos = {
  contenedorPrincipal: { display: 'flex', height: '100vh', backgroundColor: '#0a051b', color: '#ffffff', fontFamily: 'system-ui, sans-serif', margin: 0 },
  barraLateral: { width: '260px', backgroundColor: '#11092c', padding: '25px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', borderRight: '1px solid #23154c' },
  logoSeccion: { fontSize: '22px', fontWeight: 'bold', marginBottom: '10px', color: '#9d7bfb' },
  subtitulo: { fontSize: '12px', color: '#7667a4', lineHeight: '1.5', marginBottom: '30px' },
  estadoServidor: { fontSize: '14px', color: '#3cd070', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px' },
  puntoVerde: { width: '8px', height: '8px', backgroundColor: '#3cd070', borderRadius: '50%', display: 'inline-block' },
  cajaConsultas: { backgroundColor: '#1b0e42', padding: '12px', borderRadius: '6px', fontSize: '14px', border: '1px solid #331b79' },
  seccionAutor: { borderTop: '1px solid #23154c', paddingTop: '20px', marginBottom: '10px' },
  autorEtiqueta: { fontSize: '11px', color: '#7667a4', textTransform: 'uppercase', letterSpacing: '1px' },
  autorNombre: { fontSize: '18px', fontWeight: 'bold', color: '#ffffff', marginTop: '4px' },
  autorRol: { fontSize: '13px', color: '#9d7bfb', marginTop: '2px' },
  areaChat: { flex: 1, display: 'flex', flexDirection: 'column', padding: '20px', justifyContext: 'space-between' },
  tituloChat: { fontSize: '20px', textAlign: 'center', color: '#9d7bfb', fontWeight: '600', margin: '10px 0 20px 0' },
  zonaMensajes: { flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '15px', padding: '10px', marginBottom: '20px' },
  burbujaBase: { maxWidth: '75%', padding: '14px 18px', borderRadius: '12px', fontSize: '14px', lineHeight: '1.5' },
  burbujaUsuario: { backgroundColor: '#3b1c9b', alignSelf: 'flex-end', borderBottomRightRadius: '2px', color: '#ffffff' },
  burbujaIA: { backgroundColor: '#180f37', alignSelf: 'flex-start', borderBottomLeftRadius: '2px', border: '1px solid #2d1d64', color: '#e2dcf7' },
  contenedorFormularioGlobal: { display: 'flex', flexDirection: 'column', gap: '8px' },
  formulario: { display: 'flex', gap: '12px', backgroundColor: '#130a31', padding: '10px', borderRadius: '8px', border: '1px solid #2a1767' },
  inputTexto: { flex: 1, backgroundColor: 'transparent', border: 'none', color: '#ffffff', fontSize: '14px', outline: 'none', padding: '5px' },
  botonEnviar: { backgroundColor: '#562bc4', color: '#ffffff', border: 'none', padding: '10px 20px', borderRadius: '6px', cursor: 'pointer', fontWeight: 'bold', transition: 'background 0.2s' },
  firmaFooter: { fontSize: '11px', color: '#4e4175', textAlign: 'center', marginTop: '4px' }
};
